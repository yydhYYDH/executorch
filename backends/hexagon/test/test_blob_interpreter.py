...
def test_the_ops_actually_emitted_are_the_ones_we_think():
    ...
    # 1 pool2d, 3 blit, 4 unary, 8 layer norm, 14 rope, 16 add+fused norm, 18
    # flash attention, 19 element-wise, 23 shared gather, 28 softmax, 29
    # reduction, 38 batch matmul, 41 q4a16 GEMV, 43 vision attention, 45 w8a16
    # GEMV.
