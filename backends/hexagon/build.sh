...
ET_ROOT=${ET_ROOT:-/home/yydh/executorch}
HEXAGON_SDK_ROOT=${HEXAGON_SDK_ROOT:-/home/yydh/hexagon-tutorial/tools/hexagon-sdk}
HEXAGON_TOOLS_ROOT=${HEXAGON_TOOLS_ROOT:-${HEXAGON_SDK_ROOT}/tools/HEXAGON_Tools/19.0.04}
ANDROID_NDK=${ANDROID_NDK:-/home/yydh/android-ndk-r28c}
...
IDL_DIR=${IDL_DIR:-/tmp/mport/gen2}

SKEL_BUILD_DIR=${SKEL_BUILD_DIR:-/tmp/skelbuild}
HOST_BUILD_DIR=${HOST_BUILD_DIR:-${ET_ROOT}/cmake-out-android-arm64-v8a}

CMAKE=${CMAKE:-/home/yydh/miniconda3/envs/et/bin/cmake}
JOBS=${JOBS:-4}

# Optional, for ./build.sh deploy
DEVICE=${DEVICE:-oneplus13-reverse}
DEVICE_DIR=${DEVICE_DIR:-/data/data/com.termux/files/home/csm/qwen3run}
MODEL=${MODEL:-}
...
deploy() {
  ...
  scp "${ET_ROOT}/backends/hexagon/RUNBOOK.md"  "${DEVICE}:${DEVICE_DIR}/"
